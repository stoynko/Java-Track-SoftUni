package D_OOP.X_ExamPreparations.ExamPrep_07.E01_Handball;

import D_OOP.X_ExamPreparations.ExamPrep_07.E01_Handball.core.*;
...
Gameplay:
BaseGameplay is a base class of any type of Gameplay, and it should not be able to be instantiated.
Data
•	name -  String
...
Behavior
Constructor
A Gameplay should take the following values upon initialization:
...
Removes a Team from the Gameplay.
...
Child Classes
There are 2 concrete types of Gameplay:
Outdoor
Has 150 capacity.
...
(String name)
Repository
The EquipmentRepository is a repository for the equipment that is in the gameplay.
Data
•	equipments - Collection<Equipment>
Behavior
...
•	Removes equipment from the collection. Returns true if the deletion was successful, otherwise - false.
...
The first interface is Controller. You must create a ControllerImpl class, which implements the interface and implements all its methods. The constructor of ControllerImpl does not take any arguments. It should be instantiated. The given methods should have the following logic:
Data
...
Commands
There are several commands which control the business logic of the application. They are stated below. The Gameplay name passed to the methods will always be valid!
AddGameplay Command
Parameters
•	gameplayType - String
•	gameplayName - String
