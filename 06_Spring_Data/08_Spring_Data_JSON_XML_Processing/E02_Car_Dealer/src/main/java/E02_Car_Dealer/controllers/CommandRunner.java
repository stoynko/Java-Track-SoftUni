...
public class CommandRunner implements CommandLineRunner {
    ...
    public CommandRunner(SupplierService supplierService, XmlMapper xmlMapper, PartsService partsService, ObjectMapper objectMapper) {
    ...
    private void importParts(List<SupplierDTO> suppliers) {
        ...
        try {
            ...
            for (ImportPartDTO partDTO : partDTOS) {
                ...
                partsService.importPartData(partDTO, partRelationDTO);
            }
        } catch (IOException ioException) {
            throw new RuntimeException(ioException);
        }
